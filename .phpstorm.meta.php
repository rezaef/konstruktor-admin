...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./Users/aldoo1nonly./Projects/konstruktor-admin/public/storage' => 'string',
...
'filesystems.disks.s3.report','filesystems.links./Users/aldoo1nonly./Projects/konstruktor-admin/public/storage','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'session.secure','session.http_only','session.same_site','session.partitioned','excel.exports.chunk_size',
...
'web','api',);
        registerArgumentsSet('routes', 'portfolio','contact','dashboard',
'admin.projects','admin.purchases','admin.assets','admin.financial','admin.export',
...
'admin.assets','admin.dashboard','admin.export','admin.financial','admin.projects',
'admin.purchases','components.input-label','components.modal','components.primary-button','components.secondary-button',
'layouts.app','layouts.guest','public.contact','public.home','public.portfolio',
